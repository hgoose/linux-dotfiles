...
\setlength{\cftsecnumwidth}{1.5em}       % Increase for sections
\setlength{\cftsubsecnumwidth}{2em}  % Increase for subsections
\setlength{\cftsubsubsecnumwidth}{2.6em} % Increase for subsubsections
