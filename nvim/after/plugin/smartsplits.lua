...
vim.keymap.set("n", "<C-n>",  function() require("smart-splits").move_cursor_left() end)
vim.keymap.set("n", "<C-h>",  function() require("smart-splits").move_cursor_down() end)
vim.keymap.set("n", "<C-t>",  function() require("smart-splits").move_cursor_up() end)
vim.keymap.set("n", "<C-s>",  function() require("smart-splits").move_cursor_right() end)
